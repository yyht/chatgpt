...
with open('/home/htxu91/chatgpt/data/query_risk/最新风险分类query汇总.xlsx.json.chatgpt', 'w') as fwobj:
    with open('/home/htxu91/chatgpt/data/query_risk/最新风险分类query汇总.xlsx.json', 'r') as frobj:
